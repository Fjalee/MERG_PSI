    ...
    public class RealEstate : IRealEstate
    {
        ...
        public RealEstate()
        {
            _myData = new List<RealEstateModel>
            {
                ...
                new RealEstateModel { Link = "https://www.kampas.lt/skelbimai/butas-vilniuje-senamiestis-subaciaus-g-s-k-u-b-i-a-i-parduodamas-146-kvm-butas-605316", Area = 100, BuildYear = 1955, Floor = "1", Latitude = 55.0788554, Longtitude = 24.2493011, MapCoords = "55.0788554,24.2493011", MapLink = "linkas", Municipality = "Jonava", NumberOfRooms = 2, Price = 250000, PricePerSqM = 2500, Street = "gatve" ,ImageUrl="https://images.adsttc.com/media/images/5be9/fd5c/08a5/e5a5/8c00/008f/slideshow/CARLES_FAUS_ARQUITECTURA_-_CARMEN_HOUSE_(2).jpg"},
